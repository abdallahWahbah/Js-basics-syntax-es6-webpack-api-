...
export default class Movie
{
    ...
    async getMovie()
    {
        try
        {
            ...
            this.ingredients = ["1/2 cups of water", "2 tbsp olive oil", "1 teaspoon sugar", "4 ounces cheese", "4 teaspoon sauce", "feta cheese", "1 .5 ounces of sugar", "18 cup susage", "1 ounce sugar", "76 tablespoon"];
        ...
        const newIngredients = this.ingredients.map(el =>
        {
            ...
            else if (parseInt(arrIngredient[0], 10)) // 10 is decimal
            {
                ...
                objIng = 
                {
                    ...
                    unit : "",
                    ingredient : arrIngredient.split(1).join(" ") // slice not split
                }
            }
            else if(unitIndex === -1)
            {
